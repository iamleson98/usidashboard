import{d as g,r as s,G as i,H as l,c,a6 as f,u as d,O as b,t as _,ag as m,o as t,a,J as y}from"./@vue.BDy9tIRg.2025-06-28_1017.js";const k=["innerHTML"],T=["innerHTML"],v=["src","alt"],M=g({__name:"document",setup(w){const o=s([{title:"Project objective",shortDesc:"The main dashboard for managing abnormal checking time, production line heads count by realtime",content:""},{title:"Authors",content:`
    ...
    `,shortDesc:"The interface for managers to easily finding abnormal checking records, by employee ID, departments, floor, by dates range, ...",img:"/static/images/image.png"},{title:"Realtime dashboard page",shortDesc:"The realtime dashboard for managers to know how many people are actively working inside each floor, and the latest abnormal cases recorded.",content:`
